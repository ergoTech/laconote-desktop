...
const pl: Translations = {
  ...
  settings: { title: 'Ustawienia', audio: 'Audio', account: 'Konto', general: 'Ogólne', micDevice: 'Mikrofon', defaultMic: 'Domyślny', systemGain: 'Poziom dźwięku systemu', micGain: 'Poziom mikrofonu', loggedInAs: 'Zalogowany jako', logout: 'Wyloguj', notLoggedIn: 'Niezalogowany', login: 'Zaloguj się', launchAtLogin: 'Uruchom przy logowaniu', shortcutLabel: 'Skrót nagrywania', close: 'Zamknij', language: 'Język' },
